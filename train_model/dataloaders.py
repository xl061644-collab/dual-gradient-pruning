...
from transform import split,construct_policy
...
def tinyimgnet(args):
    ...
    traindir = '/data/tiny-imagenet-200/tiny-imagenet-200/train'
    testdir = '/data/tiny-imagenet-200/tiny-imagenet-200/val'
