...
def _build_dataset_vision(cfg_data, split, can_download=True):
    ...
    cfg_data.path = '/HARD-DRIVE/XLL/DGP/breaching_ATS/data/imagenet'
    if cfg_data.name == "CIFAR10":
        # _default_t = build_transform1()
        ...
        # _default_t =build_transform1()
        # print(" build_transform1()", build_transform1())
    ...
    # print(" transforms =build_transform1()")
